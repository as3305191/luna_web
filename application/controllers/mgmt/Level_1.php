...
class Level_1 extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Level_1_record_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/level_1/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/level_1/edit', $data);
	}
