...
class Level_2 extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Level_2_record_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/level_2/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/level_2/edit', $data);
	}
