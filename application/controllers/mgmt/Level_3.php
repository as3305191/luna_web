...
class Level_3 extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Level_3_record_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/level_3/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/level_3/edit', $data);
	}
