...
class Level_4 extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Level_4_record_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/level_4/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/level_4/edit', $data);
	}
