      ...
      $result = $items = $this -> records_dao -> query_ajax_for_all($data);
			...
			foreach($result as $each) {
				$lineData = array(
					...
					iconv("UTF-8","Big5//IGNORE",round($each ->weight / 1000.0,1)),
					iconv("UTF-8","Big5//IGNORE",round($each ->height)),
					iconv("UTF-8","Big5//IGNORE",round($each ->age)),
					iconv("UTF-8","Big5//IGNORE",round($each ->body_fat_rate)),
					iconv("UTF-8","Big5//IGNORE",round($each ->body_fat / 1000.0,1)),
					iconv("UTF-8","Big5//IGNORE",round($each ->visceral_fat_rate)),
					iconv("UTF-8","Big5//IGNORE",round($each ->protein_rate)),
					iconv("UTF-8","Big5//IGNORE",round($each ->moisture_rate)),
					iconv("UTF-8","Big5//IGNORE",round($each ->muscle_rate)),
					iconv("UTF-8","Big5//IGNORE",round($each ->skeletal_muscle_rate)),
					iconv("UTF-8","Big5//IGNORE",round($each ->bone_mass_rate)),
					iconv("UTF-8","Big5//IGNORE",round($each ->subcutaneous_fat_rate)),
					iconv("UTF-8","Big5//IGNORE",$each -> fat_info),
					iconv("UTF-8","Big5//IGNORE",$each -> bmr),
					iconv("UTF-8","Big5//IGNORE",$each -> physical_age),
					iconv("UTF-8","Big5//IGNORE",round($each ->bmi)),
					iconv("UTF-8","Big5//IGNORE",round($each ->bmi_best)),
					iconv("UTF-8","Big5//IGNORE",round($each ->weight_best)),
					iconv("UTF-8","Big5//IGNORE",round($each ->fat_rate_best)),
					iconv("UTF-8","Big5//IGNORE",round($each ->fat_best)),
