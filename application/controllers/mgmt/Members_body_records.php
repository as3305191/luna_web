      ...
      $filename = $date."-members_body_records.csv";
    	...
    	$f = fopen('php://memory', 'w');
			...
			$fields = array(
				...
				iconv("UTF-8","Big5//IGNORE",'健康指數'),
				iconv("UTF-8","Big5//IGNORE",'身體年齡'),
				iconv("UTF-8","Big5//IGNORE",'身體類型'),
      ...
      $result = $items = $this -> records_dao -> query_ajax_for_all($data);
			...
			foreach($result as $each) {
				$lineData = array(
					...
					iconv("UTF-8","Big5//IGNORE",$each -> weight),
					iconv("UTF-8","Big5//IGNORE",$each -> body_fat),
					...
					iconv("UTF-8","Big5//IGNORE",$each -> health_index),
					iconv("UTF-8","Big5//IGNORE",$each -> physical_age),
					iconv("UTF-8","Big5//IGNORE",$each -> body_type),
