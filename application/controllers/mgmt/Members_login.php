...
class Members_login extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Members_log_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/members_login/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/members_login/edit', $data);
	}
