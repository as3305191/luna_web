...
class Orders_v2 extends MY_Mgmt_Controller {
	...
	public function index()
	{
		...
		// $this -> to_json($data);
		$this->load->view('mgmt/orders_v2/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/orders_v2/edit', $data);
	}
	...
	public function flow($id) {
		...
		$this->load->view('mgmt/orders_v2/flow', $data);
	}
	...
	public function edit_report($id) {
		...
		$this->load->view('mgmt/orders_v2/edit_report', $data);
	}
	...
	function barcode_insert() {
		...
		$barcode_psn= $this -> get_post("barcode_psn");

		if(empty($barcode_psn)){
