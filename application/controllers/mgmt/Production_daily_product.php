...
class Production_daily_product extends MY_Base_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/production_daily_product/list', $data);
	}
	...
	public function get_data() {
		...
		$this -> session -> set_userdata('Production_daily_product_report_data', $data);
		$items = $this -> production_service -> sum_order_station_record($data);
	...
	function export_all() {
      ...
      $filename = $date."-pruduction-daily-product.csv";
			...
			$data = $this -> session -> userdata("Production_daily_product_report_data");
      ...
      $result = $items = $this -> production_service -> sum_order_station_record($data);
			$sum_weight = 0;
			$sum_number = 0;
