...
class Production_daily_product_station extends MY_Base_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/production_daily_product_station/list', $data);
	}
	...
	public function get_data() {
		...
		$this -> session -> set_userdata('Production_daily_product_station_report_data', $data);
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/production_daily_product_station/edit', $data);
	}
	...
	function export_all() {
      ...
      $filename = $date."-pruduction-daily-product.csv";
			...
			$data = $this -> session -> userdata("Production_daily_product_station_report_data");
