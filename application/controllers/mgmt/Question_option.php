			...
			case 5:
				...
				for ($j=0;$j<count($question_ans_list);$j++){//每7 option為1題
					...
					for($x=0;$x<23;$x++){
						...
						$ans_1_l = $question_ans_list[$j]->q4;
						$ans_2_f = $question_ans_list[$j]->q10;
						$ans_2_l = $question_ans_list[$j]->q11;
						$ans_3_f = $question_ans_list[$j]->q17;
						$ans_3_l = $question_ans_list[$j]->q18;
						$ans_4_f = $question_ans_list[$j]->q24;
						$ans_4_l = $question_ans_list[$j]->q25;
						$ans_5_f = $question_ans_list[$j]->q31;
						$ans_5_l = $question_ans_list[$j]->q32;
						$ans_6_f = $question_ans_list[$j]->q38;
						$ans_6_l = $question_ans_list[$j]->q39;
						$ans_7_f = $question_ans_list[$j]->q45;
						$ans_7_l = $question_ans_list[$j]->q46;
						$ans_8_f = $question_ans_list[$j]->q52;
						$ans_8_l = $question_ans_list[$j]->q53;
						$ans_9_f = $question_ans_list[$j]->q59;
						$ans_9_l = $question_ans_list[$j]->q60;
						$ans_10_f = $question_ans_list[$j]->q66;
						$ans_10_l = $question_ans_list[$j]->q67;
						$ans_11_f = $question_ans_list[$j]->q73;
						$ans_11_l = $question_ans_list[$j]->q74;
						$ans_12_f = $question_ans_list[$j]->q80;
						$ans_12_l = $question_ans_list[$j]->q81;
						$ans_13_f = $question_ans_list[$j]->q87;
						$ans_13_l = $question_ans_list[$j]->q88;
						$ans_14_f = $question_ans_list[$j]->q94;
						$ans_14_l = $question_ans_list[$j]->q95;
						$ans_15_f = $question_ans_list[$j]->q101;
						$ans_15_l = $question_ans_list[$j]->q102;
						$ans_16_f = $question_ans_list[$j]->q108;
						$ans_16_l = $question_ans_list[$j]->q109;
						$ans_17_f = $question_ans_list[$j]->q115;
						$ans_17_l = $question_ans_list[$j]->q116;
						$ans_18_f = $question_ans_list[$j]->q122;
						$ans_18_l = $question_ans_list[$j]->q123;
						$ans_19_f = $question_ans_list[$j]->q129;
						$ans_19_l = $question_ans_list[$j]->q130;
						$ans_20_f = $question_ans_list[$j]->q136;
						$ans_20_l = $question_ans_list[$j]->q137;
						$ans_21_f = $question_ans_list[$j]->q143;
						$ans_21_l = $question_ans_list[$j]->q144;
						$ans_22_f = $question_ans_list[$j]->q150;
						$ans_22_l = $question_ans_list[$j]->q151;
						$ans_23_f = $question_ans_list[$j]->q157;
						$ans_23_l = $question_ans_list[$j]->q158;
						...
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+2), $ans_1);
						...
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+6), $ans_5);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+7), $ans_6);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+8), $ans_7);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+9), $ans_8);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+10), $ans_9);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+11), $ans_10);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+12), $ans_11);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+13), $ans_12);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+14), $ans_13);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+15), $ans_14);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+16), $ans_15);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+17), $ans_16);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+18), $ans_17);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+19), $ans_18);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+20), $ans_19);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+21), $ans_20);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+22), $ans_21);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+23), $ans_22);
						$objWorkSheet->setCellValue($all_cell_name[$new_num].($x+24), $ans_23);
