...
class Quwstions_14 extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Images_dao', 'img_dao');
		$this -> load -> model('Daily_record_question_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/quwstions_14/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/quwstions_14/edit', $data);
	}
	...
	public function get_data_question() {
			...
			$list = $this -> daily_record_question_detail_dao -> query_ajax($data);
			$res['items'] =$list;
			$res['recordsFiltered'] = $this -> daily_record_question_detail_dao -> count_ajax($data, TRUE);
			$res['recordsTotal'] = $this -> daily_record_question_detail_dao -> count_all_ajax($data, TRUE);
