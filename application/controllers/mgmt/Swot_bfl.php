...
class Swot_bfl extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Swot_bfl_dao', 'dao');
	...
	public function index()
	{
		...
		$data['all_department_list'] = $this -> d_dao -> find_bfl_d_or_c();

		// $this -> to_json($data);

		$this -> load -> view('mgmt/swot_bfl/list', $data);
	}
	...
	public function edit($id) {
		...
		$data['department_list'] = $this -> users_dao -> find_all_department_bfl();

		// $this -> to_json($data);
		$this->load->view('mgmt/swot_bfl/edit', $data);
	}
	...
	public function insert_new() {
		...
		$swot_style = $this -> get_post('swot_style');
		$swot_style_list_is_lock = $this -> dao -> find_if_is_lock($swot_style,$title[0]->id);
	...
	public function export_all($id) {
		...
		// $this -> to_json($data);
		$this->load->view('mgmt/swot_bfl/export', $data);
	}
