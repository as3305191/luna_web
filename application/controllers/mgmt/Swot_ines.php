...
class Swot_ines extends MY_Mgmt_Controller {
	...
	public function new_swot_style(){
		$data = array();
		$this -> load -> view('layout/show_new_swot_ines',$data);
	}
	...
	public function new_swot_title(){
		$data = array();
		$this -> load -> view('layout/show_new_swot_title_ines',$data);
	}
