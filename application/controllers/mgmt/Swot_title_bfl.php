...
class Swot_title_bfl extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Swot_title_bfl_dao', 'dao');
		$this -> load -> model('Swot_style_bfl_dao', 'swot_style_dao');
		$this -> load -> model('Swot_bfl_dao', 'swot_dao');
	...
	public function index()
	{
		...
		// $this -> to_json($data);
		$this -> load -> view('mgmt/swot_title_bfl/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/swot_title_bfl/edit', $data);
	}
