...
class Swot_title_ines extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Swot_title_ines_dao', 'dao');
		$this -> load -> model('Swot_style_ines_dao', 'swot_style_dao');
		$this -> load -> model('Swot_ines_dao', 'swot_dao');
	...
	public function index()
	{
		...
		// $this -> to_json($data);
		$this -> load -> view('mgmt/swot_title_ines/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/swot_title_ines/edit', $data);
	}
