...
class Yield_rate_station_v2 extends MY_Base_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/yield_rate_station_v2/list', $data);
	}
	...
	public function get_data() {
		...
		if($data['type'] == '0') {
			$this -> session -> set_userdata('yield_rate_station_report_data_type_0_v2', $data);
		} else {
			$this -> session -> set_userdata('yield_rate_station_report_data_v2', $data);
		}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/yield_rate_station_v2/edit', $data);
	}
	...
	function export_all() {
      ...
      $filename = $date."-yield_rate_station.csv";
			...
			$data = $this -> session -> userdata("yield_rate_station_report_data_type_0_v2");
      ...
      $result = $items = $this -> production_service_v2 -> sum_order_station_record_group_by_station($data);
			...
			$data = $this -> session -> userdata("yield_rate_station_report_data_v2");
      $result = $items = $this -> production_service_v2 -> sum_order_station_record_group_by_station($data);
			$sum_weight = 0;
			$sum_number = 0;
			foreach($result as $each) {
