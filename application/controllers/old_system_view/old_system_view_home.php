...
class Old_system_view_home extends MY_Base_Controller {
	...
	public function get_finish_order_by_user($today,$old_user_id) {
		...
		$sql = "SELECT * FROM order_record as o_r LEFT JOIN order_menu as o_m ON o_m.id = o_r.orderid where o_m.odate = '$today' and o_r.userid='$old_user_id' and o_m.enddate IS NULL";    
