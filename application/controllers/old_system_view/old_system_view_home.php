...
class Old_system_view_home extends MY_Base_Controller {
	...
	public function get_finish_order_by_user($old_user_id) {
		...
		$sql = "SELECT order_reord.* FROM order_record LEFT JOIN order_menu ON order_record.orderid = order_menu.id where order_record.userid='$old_user_id' and order_menu.enddate IS NULL";    
