...
class Index extends MY_Base_Controller {
	...
	public function ranking() {
		...
		$all_ticket_item_m1 = count($this -> sing_dao -> find_all_ticket_by_num('m_1',$sing_status_id));
		$all_ticket_item_m2 = count($this -> sing_dao -> find_all_ticket_by_num('m_2',$sing_status_id));
		$all_ticket_item_m3 = count($this -> sing_dao -> find_all_ticket_by_num('m_3',$sing_status_id));
		$all_ticket_item_m4 = count($this -> sing_dao -> find_all_ticket_by_num('m_4',$sing_status_id));
		$all_ticket_item_m5 = count($this -> sing_dao -> find_all_ticket_by_num('m_5',$sing_status_id));
