<?php
class Menu_rating_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('menu_rating');
	...
	function find_average($menu_id){
		$this -> db -> from("$this->table_name as _m");

		$this -> db -> select('AVG(_m.score) as score');
 ...
 // Original Function
	...
	function query_ajax($data) {
		...
		$this -> db -> select('_m.*');
		// $this -> db -> select('r.role_name');
		// $this -> db -> select('st.name as station_name');
