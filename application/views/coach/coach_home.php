    ...
    <section class="g-my-30">
      ...
      <div class="container">
        <ul class="u-list-inline">
          <div id="logout" class="btn-header transparent pull-left">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <address class="g-bg-no-repeat g-font-size-12 mb-0" style="background-image: url(<?= base_url() ?>coach_1/assets/img/maps/map2.png);">
          <!-- Location -->
