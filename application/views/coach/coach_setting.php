...
<head>
  <?php $this -> load -> view("coach/coach_head")  ?>
</head>
    <!-- End Header -->

    <!-- Header -->
    <?php $this -> load -> view("coach/coach_header")  ?>
    <!-- End Header -->
    <section class="g-mb-100">
      <div class="container">
        <div class="row">
          <!-- Coach Sidebar -->
          <?php $this -> load -> view("coach/coach_sidebar")  ?>
          <!-- End Coach Sidebar -->
              ...
              <div class="tab-pane fade show active" id="nav-1-1-default-hor-left-underline--1" role="tabpanel" data-parent="#nav-1-1-default-hor-left-underline">
                <form>
                  ...
                  <div class="text-sm-right">
                    ...
                    <a class="btn u-btn-primary rounded-0 g-py-12 g-px-25" onclick="do_save_coach()">儲存</a>
                  </div>
                </form>
    ...
    <!-- Copyright Footer -->
    <?php $this -> load -> view("coach/coach_footer")  ?>
...
<!-- End JS -->
  ...
  function do_save_coach() {
  		var url = '<?= base_url() ?>' + 'coach/coach_setting/insert';
  		$.ajax({
  			url : url,
  			type: 'POST',
  			data: {
