...
固定資產(品保課.測試室.樣品室.品保實驗室.會議室十一)

固定資產(生產部.會議室十二.F. G. H. I區.倉管課.守衛室)

固定資產(員工休息室.包裝部.包裝作業課.標籤組.會議室一)

固定資產(資訊部.資訊部機房.管理部.會議室三.視覺攝影室)

固定資產(現場A區.研發工廠.A區廚房.資料庫房.物料組.成品組)


固定資產(研發部.研發測試室.研發樣品室.會議室四.實驗室.會議室七)

固定資產(業務部.業務庫品室.財務部.會議室五)

固定資產(婦幼室.總經理室.實驗餐廳.接特室.運動室.閱覽室)
