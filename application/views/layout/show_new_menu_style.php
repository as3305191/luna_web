...
<div class="col-xs-12" style="padding:20px">
    <div class="col-xs-12">
        <span style="font-size:12pt">新增菜單分類</span>
    </div>
    <hr/>
    <input type="text" class="form-control" placeholder="菜單分類" name="name" id="name" />
  ...
  $('.dosubmit').click(function() {
  		$.ajax({
  			url: '<?= base_url() ?>' + 'mgmt/menu/add_menu_style',
  			type: 'POST',
  			data: {
          menu_style : $('#name').val()
  			},
