...
<div class="col-xs-12" style="padding:20px">
    <div class="col-xs-12">
        <span style="font-size:12pt">新增公告分類</span>
    </div>
    <hr/>
    <input type="text" class="form-control" placeholder="公告分類" name="name" id="name" />
  ...
  $('.dosubmit').click(function() {
  		$.ajax({
  			url: '<?= base_url() ?>' + 'mgmt/news_edit/add_news_style',
  			type: 'POST',
  			data: {
          news_style : $('#name').val()
  			},
