...
<div class="col-xs-12" style="padding:20px">
    ...
    個人相關疲勞分數(各題加總後除以6):<span style="color:red" id="t1"></span><br>
    個人相關過勞分級(【輕微】50分以下/【中度】50-70分/【嚴重】70分以上):<span style="color:red" id="t1_s"></span><br>
    工作疲勞評估<br>
    ...
    <input type="radio" name="q3_13" value="0" id="q13_100"><label for="q13_100">總是(0)</label><br>
