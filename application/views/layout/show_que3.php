...
<script type="text/javascript">
  ...
  $('.dosubmit').click(function() {
    if ($('input:radio[name="q3_1"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_2"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_3"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_4"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_5"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_6"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_7"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_8"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_9"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_10"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_11"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_12"]:checked').val()!=='undedined'&&
        $('input:radio[name="q3_13"]:checked').val()!=='undedined'){
