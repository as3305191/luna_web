...
<div class="col-xs-12" style="padding:20px">
  ...
  $('.dosubmit').click(function() {
  		$.ajax({
  			...
  			data: {
  				// qid:$('#qid').val(),
          q1 : $("input[name='q3_1']:checked").val(),
          q2 : $("input[name='q3_2']:checked").val(),
          q3 : $("input[name='q3_3']:checked").val(),
          q4 : $("input[name='q3_4']:checked").val(),
          q5 : $("input[name='q3_5']:checked").val(),
          q6 : $("input[name='q3_6']:checked").val(),
          q7 : $("input[name='q3_7']:checked").val(),
          q8 : $("input[name='q3_8']:checked").val(),
          q9 : $("input[name='q3_9']:checked").val(),
          q10 : $("input[name='q3_10']:checked").val(),
          q11 : $("input[name='q3_11']:checked").val(),
          q12 : $("input[name='q3_12']:checked").val(),
          q13 : $("input[name='q3_13']:checked").val(),
  			},
  			dataType: 'json',
  			success: function(d) {
  				if(d) {
