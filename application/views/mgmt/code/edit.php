			...
			<form id="app-edit-form" method="post" class="form-horizontal">
				...
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" required class="form-control"  name="items" value="<?= isset($item) ? $item -> items : '' ?>"  />
						</div>
					</div>
				</fieldset>
				...
				<fieldset>
					<div class="form-group">
						<label class="col-md-3 control-label">iteml</label>
						<div class="col-md-6">
							<input type="text" required class="form-control"  name="iteml" value="<?= isset($item) ? $item -> iteml : '' ?>"  />
						</div>
					</div>
				</fieldset>
				...
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control"  name="price" value="<?= isset($item) ? $item -> price : '' ?>"  />
						</div>
					</div>
				</fieldset>
				<hr/>
				<fieldset>
					<div class="form-group">
						<label class="col-md-3 control-label">brk</label>
						<div class="col-md-6">
							<input type="number" step="0.01" class="form-control"  name="reward" value="<?= isset($item) ? $item -> brk : '' ?>"  />
						</div>
					</div>
				</fieldset>
