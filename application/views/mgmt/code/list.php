								...
								<table id="dt_list" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											...
											<th class="min100">iteml</th>
											<th class="min200">items</th>
											<th class="min100">name</th>
...
<script type="text/javascript">
	...
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/code/list.js", function(){
			currentApp = new CodeAppClass(new BaseAppClass({}));
		});
	});
</script>
