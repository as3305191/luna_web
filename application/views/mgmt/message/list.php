            ...
            if(obj==false){
                if(da.type=='rmove'){
                    ...
                    if(da.code1==mkey){
                        ...
                        obj=A.$$('<div class="row c3"><div class="col-lg-6" style="float:right;text-align:right"><p style="padding:3px 15px;float:right;"><div style="word-wrap:break-word;word-break:normal;padding:0px 20px 0px 0px;"><span style="white-space:nowrap;">['+da.time+']</span><span msg_id=""style="color:#000000;">'+da.nrong+'</span></div></p></div></div></br>');
