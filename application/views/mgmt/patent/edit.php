									...
									if(me.patnet_num||me.public_num ||me.application_num){
										if(me.patnet_num){
											if($p_id_for_priority.length>0){
												...
												item ='<span class="family_span" display=" inline-block;" style="border:3px blue double;" onclick="open_new_window('+me.id+');"><label>'+me.patnet_num+'</label><li class="select2-selection__choice__remove" role="presentation">×</li></span>'
										...
										if(me.public_num){
											if($p_id_for_priority.length>0){
												item ='<span class="family_span" display=" inline-block;" style="border:3px blue double;" onclick="open_new_window('+me.id+');"><label>'+me.public_num+'</label><li class="select2-selection__choice__remove" role="presentation">×</li></span>'
