		...
		$.ajax({
			...
			success: function(d) {
				if(d) {
					...
					// });
					$p_id_for_priority.push(d.item[0]['p_id_for_priority']);	
					$p_id_for_continuous_cases.push(d.item[0]['p_id_for_continuous_cases']);	
					$p_id_for_part_continuous_cases.push(d.item[0]['p_id_for_part_continuous_cases']);	
					$p_id_for_split_case.push(d.item[0]['p_id_for_split_case']);	
