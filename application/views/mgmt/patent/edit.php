									...
									if(me.patnet_num||me.public_num ||me.application_num){
										if(me.patnet_num){
											if($p_id_for_priority.length){
												...
												item ='<div class="family_span" display=" inline-block;" style="border:3px blue double;" onclick="open_new_window('+me.id+');"><label>'+me.patnet_num+'<li class="select2-selection__choice__remove" role="presentation">×</li></label></div>'
										...
										if(me.public_num){
											if($p_id_for_priority.length){
												item ='<div class="family_span" display=" inline-block;" style="border:3px blue double;" onclick="open_new_window('+me.id+');"><label>'+me.public_num+'<li class="select2-selection__choice__remove" role="presentation">×</li></label></div>'
