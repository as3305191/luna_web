									...
									if(me.patnet_num||me.public_num ||me.application_num){
										if(me.patnet_num){
											if($p_id_for_priority.length>0){
												...
												item ='<li class="family_span" display=" inline-block;" style="border:3px blue double;" onclick="open_new_window('+me.id+');">'+me.patnet_num+'<span class="select2-selection__choice__remove" role="presentation">×</span></li>'
										...
										if(me.public_num){
											if($p_id_for_priority.length>0){
												item ='<li class="family_span" display=" inline-block;" style="border:3px blue double;" onclick="open_new_window('+me.id+');">'+me.public_num+'<span class="select2-selection__choice__remove" role="presentation">×</span></li>'
										...
										if(me.application_num){
											if($p_id_for_priority.length>0){
												item ='<li class="family_span" display=" inline-block;" style="border:3px blue double;" onclick="open_new_window('+me.id+');">'+me.application_num+'<span class="select2-selection__choice__remove" role="presentation">×</span></li>'
