									...
									if(me.patnet_num||me.public_num ||me.application_num){
										if(me.patnet_num){
											if($p_id_for_priority.length>0){
												...
												item ='<span class="family_span" style="border:3px blue double;" onclick="open_new_window('+me.id+');">'+me.patnet_num+'<li class="select2-selection__choice__remove" role="presentation">×</li></span>'
										...
										if(me.public_num){
											if($p_id_for_priority.length>0){
												item ='<span class="family_span" style="border:3px blue double;" onclick="open_new_window('+me.id+');">'+me.public_num+'<li class="select2-selection__choice__remove" role="presentation">×</li></span>'
										...
										if(me.application_num){
											if($p_id_for_priority.length>0){
												item ='<span class="family_span" style="border:3px blue double;" onclick="open_new_window('+me.id+');">'+me.application_num+'<li class="select2-selection__choice__remove" role="presentation">×</li></span>'
