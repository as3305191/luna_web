					...
					if(d) {
						...
						if($("#item_id").val()>0){
							$.each(d.category, function(){
								...
								if(current_app[0].indexof('patnet_status_'+category_level)||current_app[0].hasOwnProperty('patnet_status_'+category_level) ||'patnet_status_'+category_level in current_app[0]){
