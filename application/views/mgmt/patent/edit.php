		...
		<div>
			...
			<fieldset>
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="file-input" name="file[]" type="file" accept="" multiple class="file-loading form-control" <?= $login_user->role_id==9 || $login_user->role_id==11 || $login_user->role_id==28? '': 'readonly' ?>>
