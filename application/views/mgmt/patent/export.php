...
<div class="" style="padding:50px 50px 50px 50px;">
	<table  class="layui-table" width="70%">
		...
		<tbody class="">
			...
			<tr>
				<td>申請人</td>
				<td><textarea type="text" require class="form-control" rows="3" id="inventor" name="inventor" style="resize:none;width:100%;border:0;" ><?= isset($item) ? $item -> applicant : '' ?></textarea></td>
				<td>發明人</td>
				<td colspan="2"><textarea type="text" require class="form-control" rows="3" id="inventor" name="inventor" style="resize:none;width:100%;border:0" ><?= isset($item) ? $item -> inventor : '' ?></textarea></td>
			</tr>
			<tr>
				<td>受讓人</td>
