...
<div class="" style="padding:50px 50px 50px 50px;">
	<table  class="layui-table" width="70%">
		...
		<tbody class="">
			...
			<tr>
				<td>專利範圍</td>
				<td colspan="4"><pre style="white-space:pre;white-space:pre-wrap;border-style:none;background-color:transparent;color:#666666;font:14px Helvetica Neue,Helvetica,PingFang SC,\5FAE\8F6F\96C5\9ED1,Tahoma,Arial,sans-serif;"><?= isset($item) ? $item -> patent_range : '' ?></pre></td>
