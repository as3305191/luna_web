			...
			<form id="app-edit-form" method="post" class="form-horizontal">
				...
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" required class="form-control"  name="plant" value="<?= isset($item) ? $item -> plant : '' ?>"  />
						</div>
					</div>
				</fieldset>
				...
				<fieldset>
					<div class="form-group">
						<label class="col-md-3 control-label">sloc</label>
						<div class="col-md-6">
							<input type="text" class="form-control"  name="sloc" value="<?= isset($item) ? $item -> sloc : '' ?>"  />
						</div>
					</div>
				</fieldset>
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control"  name="desc" value="<?= isset($item) ? $item -> desc : '' ?>"  />
						</div>
					</div>
				</fieldset>
				<fieldset>
					<div class="form-group">
						<label class="col-md-3 control-label">is_show</label>
						<div class="col-md-6">
							<input type="number" step="0.01" class="form-control"  name="is_show" value="<?= isset($item) ? $item -> is_show : '' ?>"  />
						</div>
					</div>
				</fieldset>
				<hr/>
