				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget">
						...
						<header>
							...
							<div class="widget-toolbar pull-left">
								<input id="s_sn" type="text" class="form-control" />
							</div>
							<div class="widget-toolbar pull-left">
								<label>料號</label>
							</div>
							...
							<div class="widget-toolbar pull-left">
								...
								<input id="s_product_name"  type="button" style="width:171px;position:relative;z-index:300;top:-30px;background-color: transparent; border: 0" class="form-control" />
							</div>
								...
								<table id="dt_list" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											...
											<th class="min100">重量(KG)</th>
											<th class="min100">工單原料(KG)</th>
...
loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
	loadScript(baseUrl + "js/app/product_trace/list.js?<?= time() ?>", function(){
		currentApp = new ProductTraceAppClass(new BaseAppClass({}));
	});
});
