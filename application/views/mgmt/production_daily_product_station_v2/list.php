...
<script type="text/javascript">
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/production_daily_product_station_v2/list.js?<?= time() ?>", function(){
			currentApp = new ProductionDailyProductStationv2AppClass(new BaseAppClass({}));
		});
	});
</script>
