								...
								<table id="dt_list" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											...
											<th class="min100">工單類</th>
											<th class="min100">工單欄</th>
											<th class="min100">料號</th>
											<th class="min100">品名</th>
											<th class="min100">總重(KG)</th>
											<th class="min100">噸工資代碼</th>
											<th class="min100">噸工資點數</th>
											<th class="min150">料品總點數</th>
											<th class="min150">分切成本</th>
											<th class="min150">分切總成本</th>
										</tr>
...
<script type="text/javascript">
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/production_monthly_sum/list.js?<?= time() ?>", function(){
			currentApp = new ProductionMonthlySumAppClass(new BaseAppClass({}));
		});
	});
</script>
