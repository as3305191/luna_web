		...
		switch (q_num) {
			...
			case 2: {
				layer.open({
					...
					area:['600px','800px'],
					shadeClose:true,
					content:'<?=base_url('mgmt/question_for_user/show_que2?id=')?>'+id
				})
				break;
			}
			case 3: {
				layer.open({
					...
					area:['1000px','800px'],
					shadeClose:true,
					content:'<?=base_url('mgmt/question_for_user/show_que3?id=')?>'+id
				})
				break;
			}
			case 4: {
				layer.open({
					...
					area:['800px','1000px'],
					shadeClose:true,
					content:'<?=base_url('mgmt/question_for_user/show_que4?id=')?>'+id
				})
				break;
			}
			case 5: {
				layer.open({
					...
					area:['600px','600px'],
					shadeClose:true,
					content:'<?=base_url('mgmt/question_for_user/show_que5?id=')?>'+id
				})
				break;
			}
		}
