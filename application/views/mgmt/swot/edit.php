		...
		<div >
			<fieldset id='swot_s'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_s" name="m_swot_s"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='swot_w'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_w" name="m_swot_w"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='swot_o'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_o" name="m_swot_o"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='swot_t'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_t" name="m_swot_t"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='swot_s_o'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_s_o" name="m_swot_s_o"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='swot_w_o'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_w_o" name="m_swot_w_o"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='swot_s_t'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_s_t" name="m_swot_s_t"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='swot_w_t'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_swot_w_t" name="m_swot_w_t"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
			<fieldset id='first'>
				<div class="form-group">
					...
					<div class="col-md-9">
						<textarea required class="form-control" id="m_first" name="m_first"><?= isset($item) ? $item -> content : '' ?></textarea>
					</div>
				</div>
			</fieldset>
		</div>
