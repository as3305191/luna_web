...
<canvas id="line" style="display:none;"></canvas>
	...
	<table  class="layui-table" width="70%">
		...
		<tbody class="">
			...
			<tr>
				<td style=""><img src="<?= base_url("api/images/get/603")?>" style="width:100%;height:100%;object-fit:cover;" ></td>
				<td valign="top">
					<table class="swot_table" width="100%" height="100%"  align="center">
						...
						<tr style="border-style:none">
							<td style="border-style:none"><div style="border-style:none;background-color:transparent;color:#666666;font:14px Helvetica Neue,Helvetica,PingFang SC,\5FAE\8F6F\96C5\9ED1,Tahoma,Arial,sans-serif;word-wrap:break-word;white-space:pre-wrap;"><?= isset($item) ? $item -> m_swot_s : '' ?></div></td>
						</tr>
					</table>
				</td>
				<td  valign="top">
