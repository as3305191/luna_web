...
<div class="ex_page " style="padding:20px 20px 20px 20px;">
	<table class="noBreak layui-table pageDiv layui-table1" width="70%"  style="border-color:#000;padding:0px 30px 0px 30px;" >
		<tbody class="">
			...
			<tr class="noBreak">
				<td colspan="1" class="noBreak td_table col-xs-4" style="border-color:#000 #000 #000 #000;"><img src="<?= base_url("api/images/get/947")?>" style="min-width:100%;min-height: 100%;-webkit-background-size:cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;" ></td>
