		...
		<tbody class="">
			...
			<tr>
				<td class="" colspan="3" style="border:none;text-align:center;vertical-align:middle;">
					<div style="border:none;text-align:center;vertical-align:middle;font-weight:bold;font-size:250%;padding:50px 50px 20px 50px;color:#000">寬仕工業股份有限公司</div>
			...
			<tr style="border:none;" >
				...
				<td colspan="1" valign="top" class="td_table col-xs-4" style="border:none;" >
					<span style="text-align:right;font-size:125%;color:#000;">管理代表：</span>
				</td>
				<td colspan="1" valign="top" class="td_table col-xs-4" style="text-align:right;border:none;" >
					<div  style="text-align:left;font-family:PMingLiU;font-size:125%;color:#000;" >製表：<?= isset($item) ? trim($item -> make_user) : '' ?></div>
