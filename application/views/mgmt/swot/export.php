...
<div class="ex_page " style="padding:20px 20px 20px 30px;">
	<table class="layui-table pageDiv layui-table1" width="70%"  style="border-color:#000;padding:20px 20px 20px 20px;" >
		<thead>
		</thead>
		<tbody class="">
			<!-- <tr>
