					...
					<div class="jarviswidget" > 
						<header >
							<div class="widget-toolbar pull-left">
								...
								<?php if($login_user->role_id==2 || $login_user->role_id==45 || $login_user->role_id==9): ?>
								...
								<div class="pull-left " style="width:200px;line-height:32px">
									...
									<?php if($login_user->role_id==2 || $login_user->role_id==9||$login_user->role_id==45): ?>
...
<script type="text/javascript">
	...
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/swot_bfl/list.js", function(){
			currentApp = new SwotbflAppClass(new BaseAppClass({}));
	...
	function load_list_style() {
		$.ajax({
			url: '<?= base_url() ?>' + 'mgmt/swot_bfl/find_swot_style',
			type: 'POST',
			data: {},
			dataType: 'json',
			success: function(d) {
	...
	$('#add_title').click(function() {
		layer.open({
			...
			area:['400px','200px'],
			shadeClose:true,
			content:'<?=base_url('mgmt/swot_bfl/new_swot_title')?>'
		})
	});
	...
	$('#add_swot').click(function() {
		layer.open({
			...
			area:['400px','200px'],
			shadeClose:true,
			content:'<?=base_url('mgmt/swot_bfl/new_swot_style')?>'
		})
	});
</script>
