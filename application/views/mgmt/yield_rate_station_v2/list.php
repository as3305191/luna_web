								...
								<table id="dt_list_type_0" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											...
											<th class="min150">工單欄</th>
											<th class="min150">工單</th>
											<th class="min50">件數</th>
											<th class="min150">重量(KG)</th>
											<th class="min150">日期</th>
										</tr>
...
<script type="text/javascript">
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/yield_rate_station_v2/list.js?<?= time() ?>", function(){
			currentApp = new YieldRateStationv2AppClass(new BaseAppClass({}));
			currentApp.type1 = new YieldRateStationv2AppType1Class(new BaseAppClass({}));
		});
	});
</script>
