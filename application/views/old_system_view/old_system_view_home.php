...
<script>
  ...
  function for_table(page){
    var url = baseUrl + 'old_system_view/old_system_view_home/get_data';
  ...
  function search_member(){
    var url = baseUrl + 'old_system_view/old_system_view_home/find_today_weight';
    ...
    function save_graduate() {
      var url = baseUrl + 'old_system_view/old_system_view_home/update_graduate';
  		$.ajax({
  			url : url,
  			type: 'POST',
  			data: {
