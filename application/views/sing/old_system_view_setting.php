              ...
              <div class="tab-pane fade show active" id="nav-1-1-default-hor-left-underline--1" role="tabpanel" data-parent="#nav-1-1-default-hor-left-underline">
                <form>
                  ...
                  <div class="text-sm-right">
                    ...
                    <a class="btn u-btn-primary rounded-0 g-py-12 g-px-25" onclick="do_save_old_system_view()">儲存</a>
                  </div>
                </form>
...
<!-- End JS -->
  ...
  function do_save_old_system_view() {
  		var url = '<?= base_url() ?>' + 'old_system_view/old_system_view_setting/insert';
  		$.ajax({
  			url : url,
  			type: 'POST',
  			data: {
