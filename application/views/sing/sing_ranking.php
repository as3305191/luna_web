            ...
            <?php foreach ($ticket_array as $each_key => $each_val): ?>
              ...
              <?php else : ?>
                <div class="mb-4">
                  ...
                  <div class="js-hr-progress-bar progress g-height-4 rounded-0">
                    <div class="js-hr-progress-bar-indicator progress-bar" role="progressbar" style="width: <?= $each_val ?>%;" aria-valuenow="<?= floor($each_val/$allticket) ?>" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              <?php endif; ?>
            <?php endforeach; ?>
