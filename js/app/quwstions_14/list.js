var Quwstions14AppClass = (function(app) {
	app.basePath = "mgmt/quwstions_14/";
...
var QuestionAppClass = (function(app) {
	app.basePath = "mgmt/quwstions_14/";
	app.disableRowClick = true;
	...
	app.init = function() {
		app.mDtTable = $('#question_list').DataTable($.extend(app.dtConfig,{
			ajax : {
				url : baseUrl + app.basePath + '/get_data_question',
				data : function(d) {
					d.dt = $('#dtt').val();
					return d;
				},
