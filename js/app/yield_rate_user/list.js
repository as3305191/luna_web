...
var YieldRateUserAppClass = (function(app) {
	app.basePath = "mgmt/yield_rate_user/";
...
var YieldRateUserType0AppClass = (function(app) {
	app.basePath = "mgmt/yield_rate_user/";
	app.disableRowClick = true;
	app.init = function() {
		...
		app.mDtTable.on( 'xhr', function () {
		    var json = app.mDtTable.ajax.json();
				...
				$('#sum_reward_type_0').html(numberWithCommas(sumReward.toFixed(2)));
				...
				$('#sum_reward_total_type_0').html(numberWithCommas(sumTotal.toFixed(2)));
		});
